...
import { LoginData, LoginRes, RegisterData, RegisterRes } from 'shared'
...
export class AuthService {
  ...
  register(registerData: RegisterData): Observable<RegisterRes> {
    console.log('Calling register API with user details:', registerData);
    return this.http.post<RegisterRes>(`${this.apiUrl}/register`, registerData).pipe(
      tap((response) => {
